...
const Button: React.FC<Btntype> = ({ prop, h, w }) => {
  return (
    /* From Uiverse.io by Javierrocadev */
    <button className={`group group-hover:before:duration-500 group-hover:after:duration-500 after:duration-500 hover:border-rose-300 
    ...
    hover:decoration-2 hover:text-rose-300 relative bg-neutral-800 h-${h} w-${w} border text-left p-3 text-gray-50 text-base font-bold 
